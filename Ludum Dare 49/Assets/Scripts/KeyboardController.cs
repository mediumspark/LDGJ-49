...
public class KeyboardController : ICommand
{
    ...
    public void Execute()
    {
        ...
        if (SettingsRegistry.Instance.ControlsEnabled)
        {
            if (!SettingsRegistry.Instance.DialogControls)
            {
                ...
                if (Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.LeftArrow))
                {
                    ...
                    if (!_player.GetComponent<Player>().FacingLeft)
                    {
                        ...
                        SettingsRegistry.Instance.TransitionCamera = true;
            ...
            else
            {
                ...
                {
                    GameObject.Find("Main Camera").GetComponent<GameOperationalDirector>().ScrollDialog();
                }
            }
        }
